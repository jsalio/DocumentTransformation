...
namespace Boundaries.Store.Migrations
{
    ...
    [Migration("20230318235047_WorkflowDocumentTypeSettings")]
    partial class WorkflowDocumentTypeSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.DocumentConvertSetting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("DocumentConvertSettings");
                });
            ...
            modelBuilder.Entity("Core.Models.DocumentConvertSetting", b =>
                {
                    b.HasOne("Core.Models.Workflow", "Workflow")
                        .WithMany("DocumentConvertSettings")
            ...
            modelBuilder.Entity("Core.Models.Workflow", b =>
                {
                    b.Navigation("DocumentConvertSettings");
                });
